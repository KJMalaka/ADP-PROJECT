...
public class CourseDAO {
    ...
    public List<String[]> getAllCourses() {
        ...
        String sql = "SELECT courseCode, courseName, credits FROM Courses ORDER BY courseName";
        try (Connection conn = DBConnection.getConnection();
    ...
    public List<String[]> getStudentsByCourse(String courseCode) {
        ...
        String sql = "SELECT s.studentNumber, s.studentName, s.email, e.enrollmentDate " +
                     "FROM Enrollments e " +
                     "JOIN Students s ON e.studentNumber = s.studentNumber " +
                     "WHERE e.courseCode = ? " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                student[3] = rs.getString("enrollmentDate");
