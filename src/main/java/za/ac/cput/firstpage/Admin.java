/*
 * Admin GUI with Client-Server Communication
 */
...
public class Admin extends JFrame implements ActionListener {
    ...
    private void addCourse() {
        ...
        try {
            ...
            // Add to database
            boolean added = courseDAO.addCourse(code, name, credits);
    ...
    private void addStudent() {
        ...
        try {
            ...
            boolean added = studentDAO.addStudent(num, name, email, defaultPin);
    ...
    private void viewStudentsByCourse() {
        ...
        try {
            ...
            List<String[]> students = courseDAO.getStudentsByCourse(courseCode);
            ...
            System.err.println("✗ Error viewing students by course: " + e.getMessage());
            JOptionPane.showMessageDialog(this,
                "Error viewing students by course.\n" + e.getMessage(),
                "Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void viewCoursesByStudent() {
        ...
        try {
            ...
            if (studentInfo != null && studentInfo.length > 1) {
                studentName = studentInfo[1];
            }

            // Get courses for this student
            List<String[]> courses = studentDAO.getCoursesByStudent(studentNum);
            ...
            System.err.println("✗ Error viewing courses by student: " + e.getMessage());
            JOptionPane.showMessageDialog(this,
                "Error viewing courses by student.\n" + e.getMessage(),
                "Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
